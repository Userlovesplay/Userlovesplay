...
**Front-end Developer | Full-Stack em Transição**

Desenvolvedor com experiência em React, TypeScript e JavaScript, criando interfaces de alta qualidade e experiências interativas. Atualmente expandindo para back-end.

---

## 🛠️ Tech Stack

**Front-end:** React · TypeScript · JavaScript · Tailwind CSS · Next.js · Framer Motion  
**Back-end:** Node.js · Express · Python · (aprendendo)  
**Ferramentas:** Git · Figma · Groq API
